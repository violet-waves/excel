...
class ExcelTest extends TestCase
{
    ...
    {
        $this->expectException(\VioletWaves\Excel\Exceptions\ConcernConflictException::class);
    ...
    {
        $this->expectException(\VioletWaves\Excel\Exceptions\NoTypeDetectedException::class);
